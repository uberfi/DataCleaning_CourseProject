...
#### Here is the complete Data Set Information:
...
(WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING) wearing 
...
constant rate of 50 Hz. Then they were filtered using a median filter and a 
3rd order low pass Butterworth filter with a corner frequency of 20 Hz to 
...
Here is the complete set of Features:
======================================
1 tBodyAcc-mean()-X
...
For each record we are provided:
======================================
...
Preparing the Data for the Course Project
=========================================
...
These are the measurements on the mean and standard deviations (std) for each measurement. There are 66 such measurements: 33 means and 33 standard deviations.
====================================
1 tBodyAcc-mean()-X
...
In the full dataset HAR, we use the reshape2 library to transform the transform the 
...
###################################################################
## The following sequence of codes is a stem for the EDA to follow
## More to come ...
###################################################################

```
library(ggplot2)
qplot(data = HAR, x = subject, fill = Partition)

qplot(data = HAR, x = subject, fill = Activity)
