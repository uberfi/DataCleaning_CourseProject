...
These are the measurements on the mean and standard deviations (std) for each measurement.
There are 66 such measurements: 33 means and 33 standard deviations.
